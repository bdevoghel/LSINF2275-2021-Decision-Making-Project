...
layout_custom2 = np.array(
           [ORDINARY,   GAMBLE,     RESTART,    GAMBLE,     PENALTY, 
            ...
            PRISON,     PENALTY,    RESTART,    GAMBLE,     ORDINARY], dtype=np.int8)
